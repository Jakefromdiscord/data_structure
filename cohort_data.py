...
def all_data(filename):
    ...
    for line in data:
      ...
      name = f'{first} {last}'
      all_data.append((name, house, instructor, cohort))
...
# print(get_cohort_for('cohort_data.txt', 'Laura Madley'))
...
def find_duped_last_names(filename):
    ...
    for name, _, _, _ in all_data(filename):
      last = name.split(' ')[-1]
